...
export function ChatWindow({
  ...
  return (
    <div
      ref={rootRef}
      data-lenis-prevent
      className="flex h-[min(84svh,700px)] w-[min(calc(100dvw-24px),400px)] flex-col overflow-hidden rounded-2xl border border-green/15 bg-surface shadow-[0_24px_70px_-28px_rgba(6,31,45,0.46)] sm:h-[min(80vh,720px)] sm:w-[min(calc(100vw-40px),420px)] sm:rounded-3xl"
    >
