    ...
    <>
      ...
      <main className="min-h-svh bg-bg px-6 pb-24 pt-28 sm:px-10 sm:pt-32">
        <div className="mx-auto max-w-5xl">
          {eyebrow ? <p className="eyebrow-label text-terracotta">{eyebrow}</p> : null}
          <h1 className="mt-3 break-words font-display text-[clamp(28px,4vw,44px)] font-bold leading-[1.15] text-ink">
            {heading}
          </h1>
          {subheading ? <p className="mt-3 max-w-[60ch] text-[15px] leading-[1.65] text-ink-muted">{subheading}</p> : null}
